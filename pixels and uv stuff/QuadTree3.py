...
class Boundary:
    ...
    def intersects_triangle(self, triangle):
        x_min = min(triangle.vertices[0][0], triangle.vertices[1][0], triangle.vertices[2][0])
        x_max = max(triangle.vertices[0][0], triangle.vertices[1][0], triangle.vertices[2][0])
        y_min = min(triangle.vertices[0][1], triangle.vertices[1][1], triangle.vertices[2][1])
        y_max = max(triangle.vertices[0][1], triangle.vertices[1][1], triangle.vertices[2][1])

        return not (self.x + self.width < x_min or self.x > x_max or self.y + self.height < y_min or self.y > y_max)
